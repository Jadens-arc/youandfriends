...
Current position: task `000` is `complete`. The earliest unblocked pending task is `001`.
Task `000`'s commit SHA is recorded in task `001`'s commit, per the protocol in `tasks/README.md`.

## Iteration one

| #     | Title                                                        | Phase                                | Depends on                                | Status        | Commit   | Blocker |
| ----- | ------------------------------------------------------------ | ------------------------------------ | ----------------------------------------- | ------------- | -------- | ------- |
| `000` | Repository foundation, plan, and Claude configuration        | Foundation                           | —                                         | `in-progress` | see file | —       |
| `001` | Tooling and quality gates                                    | Foundation                           | `000`                                     | `pending`     | —        | —       |
