...
Task `062` is next. `016`, `029`, `045` are passed over until their dependencies are `complete`. 45 of 95 iteration-one tasks are `complete`.
...
| `061` | EBU R128 loudness and true peak analysis                               | Media pipeline                       | `060`                                     | `complete` | —         | —       |
