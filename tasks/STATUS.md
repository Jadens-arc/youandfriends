...
Task `073` is next. `016`, `029`, `045` are passed over until their dependencies are `complete`. 56 of 95 iteration-one tasks are `complete`.
...
| `072` | Waveform rendering and seeking                                         | Persistent player                    | `063`, `071`                              | `complete` | —         | —       |
