...
Task `067` is next. `016`, `029`, `045` are passed over until their dependencies are `complete`. 50 of 95 iteration-one tasks are `complete`.
...
| `066` | Media pipeline fixture tests                                           | Media pipeline                       | `064`, `027`                              | `complete` | —         | —       |
