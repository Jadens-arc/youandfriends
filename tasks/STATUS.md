...
Task `072` is next. `016`, `029`, `045` are passed over until their dependencies are `complete`. 55 of 95 iteration-one tasks are `complete`.
...
| `071` | Persistent player interface                                            | Persistent player                    | `070`, `012`                              | `complete` | —         | —       |
