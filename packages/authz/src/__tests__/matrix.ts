...
export const NAMED_CASES: readonly MatrixCase[] = [
  ...
  {
    name: 'an invited collaborator’s grant is a folder, and nothing beyond it',
    given: 'invited to one folder, no workspace membership',
    grantLevel: 'folder',
    grantRole: 'editor',
    denyLevel: 'none',
    membershipRole: null,
    ...
    expectedDownload: false,
    because:
      'A scope-limited invitation (task 032) leaves the membership role null, so it contributes no workspace-wide baseline — only the grant it created speaks.',
  },
  {
    name: 'an invited collaborator’s grant is a project, and nothing beyond it',
    given: 'invited to one project, no workspace membership',
    grantLevel: 'project',
    grantRole: 'commenter',
    denyLevel: 'none',
    membershipRole: null,
    ...
    expectedRole: 'commenter',
    expectedDownload: false,
    because: 'The same rule at the project level — task 032 accepts invitations at any scope.',
  },
  {
    name: 'an invited collaborator’s grant is one song, and nothing beyond it',
    given: 'invited to one song, no workspace membership',
    grantLevel: 'song',
    grantRole: 'viewer',
    denyLevel: 'none',
    membershipRole: null,
    ...
    expectedDownload: false,
    because:
      'The narrowest case: someone invited to a single song sees exactly that song, never the workspace it lives in — the escalation this whole design exists to prevent (docs/THREAT_MODEL.md T2).',
  },
];
